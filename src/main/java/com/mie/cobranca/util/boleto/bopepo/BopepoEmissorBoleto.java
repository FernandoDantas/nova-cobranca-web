package com.mie.cobranca.util.boleto.bopepo;
...
import com.mie.cobranca.util.boleto.EmissorBoleto;
import com.mie.cobranca.util.modulo11.GeradorDigitoVerificador;
...
public class BopepoEmissorBoleto implements EmissorBoleto {
	...
	@Override
	public byte[] gerarBoleto(com.mie.cobranca.model.Cedente cedenteSistema
	...
	@Override
	public File gerarBoletoEmArquivo(String arquivo, com.mie.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
		Boleto boleto = criarBoleto(cedenteSistema, cobrancaSistema);
	...
	private Boleto criarBoleto(com.mie.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
	...
	private ContaBancaria criarContaBancaria(com.mie.cobranca.model.Cedente cedenteSistema) {
	...
	private Titulo criarTitulo(ContaBancaria contaBancaria, Sacado sacado, Cedente cedente
			, com.mie.cobranca.model.Cobranca cobrancaSistema) {
